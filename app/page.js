        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-3">
              {['Real-world skills taught through live projects', 'Industry-certified expert trainers with 10+ years experience', 'Training certificate is provided', 'Placement assistance and interview guidance is provided'].map((p) => (
